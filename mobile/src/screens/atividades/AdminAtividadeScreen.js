...
import { getAtividades, deleteAtividade } from "../../services/AtividadeService";
...
const AdminAtividadeScreen = ({ navigation }) => {
  ...
  const handleEdit = (atividade) => {
    navigation.navigate("FakeScreen", { id: atividade.id });
  };
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Administração de Atividades</Text>
      <CustomButton title="Nova Atividade" onPress={handleNewAtividade} />
      <EditableList
        items={atividades}
        onEdit={handleEdit}
